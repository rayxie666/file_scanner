...
The system SHALL display four visible corner handles at each corner of the crop region with minimum touch target size.
...
- **THEN** handle enlarges or changes color to indicate selection
...
The system SHALL provide clear actions to confirm or cancel crop adjustments.

#### Scenario: User confirms crop
- **WHEN** user taps "Done" or checkmark button
